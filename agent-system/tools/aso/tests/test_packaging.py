...
class PackagingCommandTests(unittest.TestCase):
    ...
    def test_install_smoke_target_covers_clean_console_import_path(self) -> None:
        ...
        self.assertIn("agent-system/tools/aso/tests/current_source_snapshot.py . \"$$current_src\"", makefile)
        self.assertIn("agent-system/scripts/install_aso_clean.sh --source \"$$current_src\"", makefile)
