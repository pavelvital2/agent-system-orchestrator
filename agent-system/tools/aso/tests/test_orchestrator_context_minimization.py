...
class OrchestratorContextMinimizationTests(unittest.TestCase):
    ...
    def test_routine_context_uses_compact_machine_readable_inputs(self) -> None:
        ...
        self.assertIn("agent-system/01_roles/DEVELOPER.md", paths)
        self.assertIn("agent-system/03_templates/AGENT_RESULT_TEMPLATE.md", paths)
    ...
    def test_debug_and_explain_reference_docs_require_authorization(self) -> None:
        code, report, stderr = self._context_report(
            "--context-mode",
            "debug",
            "--reference-doc",
