...
REQUIRED_MAKEFILE_COMMANDS = (
    ...
    'current_source_snapshot.py . "$$current_src"',
    'install_aso_clean.sh --source "$$current_src" --venv',
    'git -C "$$current_src" archive',
    "agent-system/scripts/installed_cli_smoke.sh",
    "clean-console",
    "wheel-console",
    "sdist-console",
