...
TESTING_TASK_REFS: TASK_GIANT_001
SOURCE_REFS: project-docs/requirements.md#REQ-001

## TASK_DAG
NODE_ID: NODE-001
TASK_OR_ARTIFACT_REF: TASK_GIANT_001
ROLE: developer
...
ARTIFACT_REF: TASK_GIANT_001
CLASSIFICATION: task_packet
DISPATCH_STATUS: dispatchable
SCHEMA_STATUS: passed
TARGET_ROLE: developer tester technical_writer
TASK_KIND: correction
REQUIRED_DOCS: agent-system/03_templates/DESIGN_OUTPUT_CONTRACT.md
ACCEPTANCE_SUMMARY: Implement the feature, independently test it, update documentation, and prepare release handover in one task.
...
IMPACT: low
MITIGATION: tests
OWNER_OR_NEXT_TASK: TASK_GIANT_001
SOURCE_OR_DECISION_REF: DEC-001
STATUS: accepted
