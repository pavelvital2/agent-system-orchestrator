...
ORCHESTRATOR_RUNTIME_CONTRACT_JSON = r"""{
  ...
  "source_boundary_contract": {
    "schema_ref": "agent-system/09_validators/schemas/allowed_sources.schema.json",
    "template_ref": "agent-system/03_templates/allowed_sources.template.json",
    ...
    "correction_required_for": [
      "SB3_BLOCKING",
      "SB4_INVALIDATING"
    ],
    "fresh_agent_required_for": [
      "SB4_INVALIDATING"
    ],
    ...
    "correction_routing_rule": "Create correction tasks only for SB3_BLOCKING or SB4_INVALIDATING source-boundary findings. SB0_ALLOWED, SB1_REPORTING_ONLY, and SB2_GOVERNANCE_WARNING are reported without correction task creation."
  },
  "artifact_contracts": {
