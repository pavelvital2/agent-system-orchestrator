...
assert_version_changelog_coherence() {
  ...
  awk -v pkg="CURRENT_PACKAGE_VERSION: 3.6.0" \
    ...
    -v runtime_marker="RUNTIME_STATE_RELEASE_MARKER: project-design-gap-governance-p4" '
  ...
  ' "$PACKAGE_README" || die "README current active tuple missing 3.6.0 / 3.6.0 / 3.1.0 Project Design Gap Governance P4 marker"
